...
docker run -d -v %cd%/src/main/resources/db/data:/var/lib/mysql -p 3306:3306 --rm --name mysql-container mysql-image --default-authentication-plugin=mysql_native_password